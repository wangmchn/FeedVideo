...
typedef NS_ENUM(NSUInteger, FVContinuePolicy) {
    FVContinuePolicyNone,      // 什么也不做
    FVContinuePolicyPlayNext,  // 播下一个
    FVContinuePolicyReplay,    // 重播
    FVContinuePolicyStop,      // 停止播放
    FVContinuePolicyRemove,    // 移除播放器
    FVContinuePolicyRemoveAndPlayNext, // 移除播放器并续播下一个
};
